...
A: bin mir hier ziemlich unsicher, gibt nahezu nichts in der Vorlesung dazu
...
-   Funktionale Problemdekomposition
  ...
  **Parameter**   Ausprägung                       
  --------------- -------------- ----------------- --------------
  Marke           Mercedes       Audi              BMW
  Typ             Coupe          Familienkutsche   Kleinstwagen
  Farbe           Schwarz        Weiß              Blau / Weiß
  Gewicht         1,5 Tonnen     2 Tonnen          250 kg
  Preis           100.000 Euro   900.000 Euro      20.000 EUR
...
Bei "Beispielen an Merkmalen" denke ich eher an was anderes. Das was hier aufgelistet ist, sind ja eher Beispiele von Merkmalsausprägungen. Ich hätte hier gesagt (bin mir aber auch nicht ganz sicher):
...
A: Bin mir ein wenig unsicher welche Merkmale diskret sind.
...
Meiner Meinung nach richtiger Lösung hier:

Nur Merkmal Methode ist diskret, auf der Abb. Hat kann es 4 mögliche Werte annehmen:

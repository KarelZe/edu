...
2.  Keine Wahl von Cut-Methoden notwendig

3.  Finden interessanter Warenkörbe mit mehr als zwei Artikeln möglich

4.  Assoziationsregeln treffen keine Modellannahmen über Unabhängigkeit von Kaufprozessen, die Einsatz des Modells zunichtemachen, wenn sie nicht gelten.

5.  Beschränken der Berechnungen je nach Anzahl gewünschter Empfehlungen möglich (z.B. L7 für max. 6 Empfehlungen)

**Nachteil:**

6.  Verfahren berücksichtigt keine statistischen Zusammenhänge z. B. besteht keine Möglichkeit Ergebnisse statistisch zu interpretieren

7.  Erfordert die Vorgabe zwei externen, nicht aus dem Modell begründbare Parameter $s_{\min}$ und $c_{\min}$.

8.  Parameter lassen sich ex ante nur schwer bestimmen. (Folie 52 + 53)
...
Sup(a)= 3/6; Sup(b) = 4/6; Sup(c) = 1/6; Sup(d) = 5/6; Sup(e) = 3/6, Sup(f) = 2/6 -\> Eliminierung {c}, {f} -\> L1={{a},{b},{d},{e}}
...
9.  Keine Wahl von Cut-Methoden notwendig

10. Finden interessanter Warenkörbe mit mehr als zwei Artikeln möglich

**Nachteil:**

11. Verfahren berücksichtigt keine statistischen Zusammenhänge

12. Erfordert die Vorgabe zwei externen, nicht aus dem Modell begründbare Parameter s(min) und c(min)

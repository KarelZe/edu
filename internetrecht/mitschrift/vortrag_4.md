---
description: >-
  Mitschrift zum Vortrag mit dem Titel "Das IT-Sicherheitsgesetz in der Praxis: Das BSI als zentrale Bundesbehörde für IT-Sicherheit nach dem IT-Sicherheitsgesetz 2.0" von Moritz Glade.
---
...
- **Beispiele:**
  ...
  - Bankensystem ist nicht kritisch
...
- Grenzübergreifende Identifizierung sg. *smart borders*.
- Vorgaben für Staat
...
- Detektion von Auskunftsverlangen zur Ergänzung der Untersuchung von auf dem Markt bereitgestellte IT-Produkten (§ 7a BSIG)
...
![Entwicklung der BSI-Gesetzgebung durch EU-Recht (Glade; 2022)](../../.gitbook/assets/entwicklungen_bsi.jpg)
...
- **Neue Unternehmen im besonderen öffentlichen Interesse (UBIs)**
  ...
  - Aufweichung des Versorgungsgrad-Ansatz &rightarrow; Fortsetzung in NIS-2
